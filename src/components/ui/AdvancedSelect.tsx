...
export function AdvancedSelect(props: AdvancedSelectProps) {
  ...
  return (
    <div class={`relative space-y-1.5 w-full ${props.class || ""}`} ref={containerRef}>
      ...
      <Show when={isOpen()}>
        <div class="absolute z-50 w-full mt-1.5 bg-white dark:bg-forest-800 border-2 border-cream-200 dark:border-forest-600 rounded-xl shadow-xl overflow-hidden">
          {/* Search Area */}
          <div class="p-2 border-b border-cream-100 dark:border-forest-700">
            <div class="relative">
