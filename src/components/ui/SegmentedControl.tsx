                ...
                {(option) => {
                    ...
                    return (
                        <button
                            ...
                            class={`flex items-center justify-center gap-1.5 rounded-md font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-forest-500/30 focus:ring-offset-1 focus:ring-offset-cream-100 dark:focus:ring-offset-forest-900/40 ${props.size === "sm" ? "px-2 py-1 text-xs" : "px-3 py-1.5 text-xs sm:text-sm"
                                } ${isActive()
