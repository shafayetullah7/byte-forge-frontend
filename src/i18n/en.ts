export const dict = {
  ...
  seller: {
    ...
    verification: {
      ...
      existingDocuments: "Currently Uploaded Documents",
      currentlyUploaded: "Currently uploaded - upload new file to replace",
      current: "Current",
      replaceDocumentsHint: "💡 Tip: Upload new documents in the sections below to replace the existing ones. Only upload if you want to make changes.",
