export const dict = {
  ...
  seller: {
    ...
    shop: {
      ...
      myShop: {
        ...
        shopInfo: {
          ...
          description: "Description",
          businessHours: "Business Hours",
          storefrontSection: "Storefront story",
          tagline: "Tagline",
          about: "About",
          sellerStory: "Seller story",
          brandMission: "Brand mission",
          whyChooseUs: "Why choose us (one per line)",
          values: "Values (one per line)",
          categoriesServed: "Categories served (one per line)",
          linesPlaceholder: "One item per line",
        ...
        storefront: {
          title: "Storefront",
          subtitle: "Manage the public story and trust content buyers see on your shop profile",
          previewPublic: "Preview public shop",
          manageProducts: "Manage products",
          categoriesHint: "Categories are derived automatically from your active plant listings.",
          emptyList: "No items yet. Add your first entry.",
          addItem: "Add item",
          profileSaved: "Storefront profile saved",
          whyChooseUsSaved: "Why choose us updated",
          valuesSaved: "Values updated",
          saveFailed: "Failed to save storefront content",
          sections: {
            taglineStory: "Tagline & story",
          },
        },
        branding: {
      ...
      editPage: {
        pageTitle: "Edit Shop",
        pageSubtitle: "Update your shop information",
        nameCardTitle: "Shop Name (requires re-verification)",
        descriptionCardTitle: "Description (immediate update)",
        businessHoursCardTitle: "Business Hours (immediate update)",
        contactCardTitle: "Contact Information (immediate update)",
        nameEnLabel: "Shop Name (English)",
        nameBnLabel: "Shop Name (Bengali)",
        nameChangeWarning: "Changing the name requires admin re-verification.",
        descriptionEnLabel: "Description (English)",
        descriptionBnLabel: "Description (Bengali)",
        businessHoursLabel: "Business Hours",
        businessHoursPlaceholder: "e.g., Mon–Sat 9AM–6PM",
        contactEmailLabel: "Contact Email",
        contactPhoneLabel: "Contact Phone",
        saveMinorChanges: "Save Minor Changes",
        submitMajorChanges: "Submit Major Changes",
        modalSaveTitle: "Save Changes",
        modalSubmitTitle: "Submit for Review",
        modalMajorBody: "You are submitting major changes (shop name) for admin review.",
        modalMajorWarning: "Your shop will be set to pending verification until an admin approves the changes.",
        modalMinorBody: "Your changes will be applied immediately.",
        updateFailed: "Failed to update shop",
      },
      deletePage: {
        pageTitle: "Delete Shop",
        warningTitle: "Warning: This action cannot be undone",
        warningItem1: "Your shop will be permanently deleted",
        warningItem2: "All products will be deactivated",
        warningItem3: "You cannot create a new shop for 30 days",
        warningItem4: "Pending orders must be completed first",
        cannotDeleteTitle: "Cannot Delete Shop",
        cannotDeleteBody:
          "You have pending orders that must be completed before deleting your shop. Please complete or cancel all pending orders, or contact admin for assistance.",
        shopLabel: "Shop",
        slugLabel: "Slug",
        statusLabel: "Status",
        confirmPrompt: 'Type "DELETE" to confirm:',
        confirmPlaceholder: "DELETE",
        confirmTypeMismatch: "Please type DELETE to confirm",
        cancel: "Cancel",
        deleteButton: "Delete Shop",
        deleteFailed: "Failed to delete shop. Please try again.",
      },
      historyPage: {
        pageTitle: "Verification History",
        pageSubtitle: "Track verification actions and status changes for your shop",
      ...
      tradeLicenseDocumentDesc: "PDF or Image (max 3MB) - Required",
      tinDocumentLabel: "TIN Document",
      tinDocumentDesc: "PDF or Image (max 3MB) - Optional",
      utilityBillDocumentLabel: "Utility Bill Document",
      utilityBillDocumentDesc: "PDF or Image (max 3MB) - Optional",
      // Navigation
    ...
    campaigns: {
      title: "Campaigns",
      subtitle: "Create and manage shop promotions",
      create: "New campaign",
      edit: "Edit",
      ...
      fields: {
        ...
        descriptionHint: "Longer pitch — explain the offer and who it is for.",
        ...
        bannerHint: "Hero image on the campaign detail page.",
        productsHint: "Link up to 50 active products featured in this campaign.",
        ...
        products: {
          ...
          selectedCount: (n: number) => `${n} product${n !== 1 ? "s" : ""} selected`,
    ...
    articles: {
      title: "Articles",
      subtitle: "Publish care tips and shop stories",
      create: "New article",
      edit: "Edit",
      ...
      fields: {
        ...
        coverHint: "Image shown on article list and detail pages.",
    ...
    products: {
      ...
      plantOverview: {
        ...
        seasonalCareBn: "মৌসুমি যত্ন",
        noCareInstructions: "No care instructions available for this plant.",
        // Pricing & Inventory
        ...
        // Quick actions
        quickActions: "Quick Actions",
        publishPlant: "Publish Plant",
        confirmPublishTitle: "Publish plant?",
        confirmPublishDescription: "This plant will become visible to buyers once published.",
        publishSuccess: "Plant published successfully",
        publishFailed: "Failed to publish plant",
        confirmArchiveTitle: "Archive plant?",
        confirmArchiveDescription: "Archived plants are hidden from buyers. You can publish again later.",
        archiveSuccess: "Plant archived successfully",
        archiveFailed: "Failed to archive plant",
        confirmDeleteTitle: "Delete plant?",
        confirmDeleteDescription: (p: { name: string }) =>
          `This permanently deletes "${p.name}" and cannot be undone. Type the plant name below to confirm.`,
        deleteConfirmLabel: "Type plant name to confirm",
      ...
      newPlant: {
        ...
        thumbnailDesc: "Main image shown in listings (JPEG, PNG, WEBP, or GIF — max 3MB)",
        ...
        inventoryCountLabel: "Available stock",
        inventoryCountPlaceholder: "0",
        initialStockLabel: "Initial stock",
        initialStockPlaceholder: "0",
        initialStockHint: "Set once at creation. Use the Inventory tab to restock later.",
        stockUntrackedSummary: "Untracked",
        ...
        englishLabel: "English",
        variantImagesLabel: (count: number) => `Variant Images (${count}/10)`,
        variantImageAlt: (n: number) => `Variant ${n}`,
        variantImagePlaceholder: "IMG {n}",
        imageUploadPrompt: "Click to add image (max 3MB)",
        imageUploading: "Uploading...",
        imageUploaded: "Image uploaded",
        imageSizeError: "Image must be less than 3MB",
  ...
  public: {
    ...
    shops: {
      ...
      detail: {
        ...
        followSuccess: "You are now following this shop",
        unfollowSuccess: "You unfollowed this shop",
