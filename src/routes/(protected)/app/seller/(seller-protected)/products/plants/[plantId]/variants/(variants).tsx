...
export default function VariantsRoute() {
  ...
  const variants = createMemo(() => plant()?.variants ?? []);
  ...
  return (
    <ErrorBoundary fallback={(error) => (
      ...
      <Show when={variants().length > 0} fallback={
                  ...
                  <div class="p-6">
                    ...
                    <div class="mt-6 pt-4 border-t border-cream-100 dark:border-forest-700/50">
                      <div class="flex items-center gap-2 mb-3">
                        ...
                        <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Images ({variant.media.length})</p>
                      </div>
