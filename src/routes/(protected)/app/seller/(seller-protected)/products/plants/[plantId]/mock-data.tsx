...
export const MOCK_PLANT = {
  ...
  plantDetails: {
    lightRequirement: LIGHT_REQUIREMENT.BRIGHT_INDIRECT,
    wateringFrequency: WATERING_FREQUENCY.WEEKLY,
    humidityLevel: HUMIDITY_LEVEL.HIGH,
    careDifficulty: CARE_DIFFICULTY.INTERMEDIATE,
    growthRate: GROWTH_RATE.MODERATE,
  ...
  variants: [
    {
      ...
      attributes: {
        ...
        variegation: VARIEGATION.ALBO,
        leafDensity: LEAF_DENSITY.DENSE,
        stemCount: 3,
        currentHeight: "45cm",
        currentSpread: "35cm",
        propagationType: PROPAGATION_TYPE.CUTTING,
    ...
    },
    {
      ...
      attributes: {
        ...
        plantForm: PLANT_FORM.UPRIGHT,
        variegation: VARIEGATION.ALBO,
        leafDensity: LEAF_DENSITY.MODERATE,
        stemCount: 1,
        currentHeight: "25cm",
        currentSpread: "20cm",
        propagationType: PROPAGATION_TYPE.CUTTING,
