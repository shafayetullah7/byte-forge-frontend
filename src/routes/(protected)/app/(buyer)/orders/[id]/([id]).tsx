                                ...
                                <For each={order.items}>
                                    {(item) => (
                                        <li class="p-6 flex items-center gap-4">
                                            <div class="w-16 h-16 bg-gray-100 dark:bg-forest-700 rounded-lg flex-shrink-0">
                                                {/* Image placeholder */}
                            ...
                            <div class="space-y-4">
                                <div class="flex gap-4">
                                    <div class="mt-1 relative">
                                        ...
                                        <div class="absolute top-4 left-1.5 w-0.5 h-full bg-gray-200 dark:bg-forest-700 -z-10"></div>
                                    </div>
                                    <div>
