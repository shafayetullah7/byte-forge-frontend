                ...
                <div class="bg-white dark:bg-forest-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <button
                                disabled
                                class="px-6 py-3 bg-gray-200 dark:bg-forest-700 text-gray-900 dark:text-white rounded-lg hover:bg-gray-300 dark:hover:bg-forest-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                            >
                            ...
                            <button
                                ...
                                class="px-6 py-3 bg-forest-600 dark:bg-forest-700 text-white rounded-lg hover:bg-forest-700 dark:hover:bg-forest-600 transition-colors font-medium"
                            >
                                {t("common.signOut")}
                            </button>
                            <button
