      ...
      <div class="p-4">
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0">
            ...
            <p class={`text-sm font-medium mt-2 ${stockColor()}`}>{stockLabel()}</p>
          </div>
          <p class="text-lg font-bold text-forest-800 dark:text-cream-50 shrink-0">{formatPrice(props.variant.price)}</p>
        </div>
      </div>
    </button>
  );
